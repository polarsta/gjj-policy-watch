...
function buildAdviceCards(city, items) {
  ...
  const ACT_ADV = {
    ...
    removed: () => '建议分行关注该中心领导班子补位安排，保持与中心其他班子成员的常态化业务沟通衔接，确保合作平稳过渡；待补位人选明确后及时拜访，衔接年度合作计划。',
    pending: () => '目前处于任前公示阶段。建议分行关注正式任命进展，待其到任后及时拜访，介绍我行公积金服务能力与年度合作计划，抢占合作先机。',
    mid: () => '属中层干部调整，建议及时拜访。建议分行安排属地支行负责人走访新任干部，围绕分中心、管理部辖区业务深化日常对接与服务响应。',
    staff: () => '属非领导职务调整，触达价值有限，供分行参考，无需专项拜访。',
    sup: p => `分管市领导对公积金政策方向与管委会决策有重要影响。建议及时拜访，通过公积金管委会会议、政府条线汇报等渠道对接${p.persons}，汇报我行公积金金融服务方案与年度合作成果，争取政策与业务支持。`
  };
