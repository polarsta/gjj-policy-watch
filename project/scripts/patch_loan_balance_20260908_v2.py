...
USER_FILL = {
    ...
    # ⚠️ 2026-09-08 v3 已更正：2964.23 为河南省全省口径（误取），洛阳市级正确值 283.43 / -0.58%
    #    （出自《河南省住房公积金2025年年度报告》表3 分城市表）。此行仅作历史留痕，勿再回退。
    '洛阳': (283.43, '-0.58%',
...
SPECIAL = {
    ...
    '南宁': {'value': 323.04, 'yoy': '-3.71%', 'extract_method': '年报正文',
             'note': '市中心（含铁路分中心）口径；另有区直分中心贷款余额 211.91 亿元（+3.49%），'
                     '两个中心合计 534.95 亿元'},
    # 大连：年报未披露同比，按 2024 年末余额 736.00 亿元计算 +1.41%（2026-09-08 v3 经用户人工核对确认）
    '大连': {'yoy': '+1.41%',
