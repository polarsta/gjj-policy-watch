...
VERIFIED = {
    ...
    # 第三轮抽查（2026-09-03）：14 条域名全对，收尾批次
    "杭州": ("https://gjj.hangzhou.gov.cn/", "人工查证补录",
             "第三轮抽查确认；独立部门站，title『杭州住房公积金管理中心』；http 301→https"),
    "温州": ("https://zfgjj.wenzhou.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『温州市住房公积金管理中心』；http 301→https"),
    "扬州": ("https://gjjzx.yangzhou.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『扬州市住房公积金管理中心』；双通且 http 不强制跳转，入库取 https"),
    "绍兴": ("https://gjj.sx.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『绍兴市住房公积金管理中心』；sx.gov.cn 主域下的部门独立子站"),
    "嘉兴": ("https://gjj.jiaxing.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title 为『首页』，meta SiteName『嘉兴市住房公积金管理服务中心』（机构现名）"),
    "黄冈": ("https://gjj.hg.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『黄冈住房公积金中心』，网站标识码 4211000027"),
    "成都": ("https://cdzfgjj.chengdu.gov.cn/", "人工查证补录",
             "第三轮抽查确认；curl 双协议均 412，系瑞数动态防护（响应含 $_ts 挑战），"
             "浏览器实测正常，title『成都住房公积金管理中心』、标识码 5101000018"),
    "咸阳": ("https://zfgjj.xianyang.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『咸阳市住房公积金管理中心』，《2025年度政府网站工作年度报表》首页网址，标识码 6104000064"),
    "昆明": ("https://zfgjj.km.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『昆明市住房公积金管理中心』，中心官方信件回复自述此址"),
    "遵义": ("https://zfgjj.zunyi.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『遵义市住房公积金管理中心』，遵义市政府门户『市住房公积金管理中心基本信息』登记此址"),
    "潍坊": ("https://gjj.weifang.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『潍坊市住房公积金管理中心』；wfgjj.gov.cn 为综合服务平台，官网以本址为准"),
    "东营": ("http://dygjj.dongying.gov.cn/", "人工查证补录",
             "第三轮抽查确认，**仅 http 可用**：https 返裸 403（网关未下发该域名证书，openssl 取不到证书），"
             "非站点失效；title『东营市住房公积金管理中心』，《2024年度政府网站工作年度报表》首页网址，标识码 3705000064"),
    "厦门": ("https://gjj.xm.gov.cn/", "人工查证补录",
             "第三轮抽查确认；计划单列市本级独立机构，title『厦门市住房公积金中心』，标识码 3502000052"),
    "宁德": ("https://gjj.ningde.gov.cn/", "人工查证补录",
             "第三轮抽查确认；title『宁德市住房公积金管理中心』，宁德市政府《市级行政执法主体名单》载明此址"),
    # 第一轮抽查已确认正确（4/5 中的 4 条），当时只入库了廊坊，本批补齐
    "绵阳": ("https://gjj.mianyang.cn/", "人工查证补录",
             "第一轮抽查确认；http/https 双通，入库取 https"),
    "泸州": ("https://zfgjj.luzhou.cn/", "人工查证补录",
             "第一轮抽查确认；有官方《域名变更通告》背书；http/https 双通，入库取 https"),
    "锦州": ("https://jzsgjj.cn/", "人工查证补录",
             "第一轮抽查确认；http/https 双通，入库取 https"),
    "娄底": ("https://www.ldgjj.com/", "人工查证补录",
             "第一轮抽查确认；**仅 https 可用**（http 连接超时），入库取 https"),
}
